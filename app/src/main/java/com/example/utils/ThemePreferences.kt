...
object ThemePreferences {
    ...
    fun setAnimationUrl(context: Context, value: String) {
        getPrefs(context).edit().putString("anim_url", value).apply()
    }

    fun getAnimationUrl(context: Context): String {
        return getPrefs(context).getString("anim_url", "") ?: ""
    }
